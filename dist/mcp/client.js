...
exports.getConnectedServers = getConnectedServers;
exports.shutdownMCP = shutdownMCP;
const child_process_1 = require("child_process");
const logger_js_1 = require("../utils/logger.js");
const config_js_1 = require("./config.js");
const logger = (0, logger_js_1.createModuleLogger)('mcp-client');
// Active MCP servers
 ...
 */
function handleServerOutput(server, data) {
    server.buffer += data;
 ...
 */
function parseToolName(prefixedName) {
